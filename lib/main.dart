...
class _GamePageState extends State<GamePage>
  ...
  void _animateWidget() {
    ...
    if (_isTopLeft) {
      _leftAnimation =
          Tween<double>(begin: width / 2 - 170, end: 300).animate(_controller);
      _topAnimation =
          Tween<double>(begin: height - 300, end: 1).animate(_controller);
      _imageSize = Tween<double>(begin: 70, end: 20).animate(_controller);
    } // } else {
    //   _leftAnimation =
    //       Tween<double>(begin: width / 2 - 35, end: 0).animate(_controller);
    //   _topAnimation =
    //       Tween<double>(begin: height - 100, end: 0).animate(_controller);
    // }
